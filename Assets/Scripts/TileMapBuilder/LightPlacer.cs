...
public class LightPlacer : MonoBehaviour
{
    ...
    public void PlaceLight(int itemReference, Vector2Int coords)
    {
        //Instantiate the object
        GameObject newThing = Instantiate(lightPrefabs[itemReference], new Vector3(coords.x, coords.y, 0), Quaternion.identity);
